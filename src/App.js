  ...
  return (
    <div className="App">
      ...
      <div className="writing-main-text">
        ...
        <p>My writing focuses on cities, health, education, and innovation. I'm interested in how journalism can illuminate untold narratives of urban struggle and prosperity. At Yale, my long-form essay about independent primary care clinics entitled, <i>What One Small Health Clinic Tells Us About Healing</i>, won the Williams H. Schubart prize for a distinguished piece on nonfiction writing. I also worked as a reporting intern for the Financial Times' industry publication, <a href="https://www.ftspecialist.com/" target="_blank" rel="noopener noreferrer">Health Payer Specialist</a>, where I wrote about innovation and equity in the health insurance industry.</p>
        <p>Selected Work:</p>
        <ul>
