    ...
    <div className="intro-page-together">
        <img className="photo" src={Me} alt="me"/>
          <div className="description">
            ...
            <p>I'm a Richmond, VA native and master's student at the Bartlett School of the Built Environment, University College London. I’m interested in how urban struggles map onto poor urban planning decisions, how informal networks of community interactions shape neighborhoods, and how cities can be designed to promote equity and justice. My master’s is supported by the UK-US Fulbright. Prior to UCL, I <a href="https://news.yale.edu/2021/05/20/using-data-and-technology-create-more-just-world" className="links-to-previous-jobs" target="_blank" rel="noopener noreferrer">graduated</a> from Yale in 2021 with a degree in applied mathematics.</p>
