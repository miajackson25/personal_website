    ...
    <div className="intro-page-together">
        <img className="photo" src={Me} alt="me"/>
          <div className="description">
            ...
            <p>I'm a Richmond, VA native and master's student at the Bartlett School of the Built Environment, University College London. I’m interested in participatory placemaking, data-informed urban design, and how informal social networks shape neighborhoods. My master’s is supported by the UK-US Fulbright. Prior to UCL, I <a href="https://news.yale.edu/2021/05/20/using-data-and-technology-create-more-just-world" className="links-to-previous-jobs" target="_blank" rel="noopener noreferrer">graduated</a> from Yale in 2021 with a degree in applied mathematics.</p>
  ...
  return (
    <div className="App">
      ...
      <div className="writing-main-text">
        ...
        <p>I write about anything in the realm of cities, health, education and innovation, but my favorite stories are about local heroes solving local problems. My work has been supported by the Economic Hardship Reporting Project and published in the Solutions Journalism Network.</p><p>At Yale, my long-form essay about independent primary care clinics entitled, <i>What One Small Health Clinic Tells Us About Healing</i>, won the Williams H. Schubart prize for a distinguished piece on nonfiction writing. I also worked as a reporting intern for the Financial Times' industry publication, <a href="https://www.ftspecialist.com/" target="_blank" rel="noopener noreferrer">Health Payer Specialist</a>, where I wrote about innovation and equity in the health insurance industry.</p>
        <p>Selected Work:</p>
        <ul>
